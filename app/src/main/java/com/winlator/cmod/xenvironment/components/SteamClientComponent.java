...
/**
 * Environment component that runs a local SteamPipeServer.
 * This allows games using the Goldberg Steam emulator to communicate
 * with a fake Steam client, enabling Steam API features like
